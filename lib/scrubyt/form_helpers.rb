    ...
    module FormHelpers
      ...
      private
        def submit(xpath)
          ...
          notify(:submit, xpath)
          @agent.element(:xpath => xpath).click
        ...
        def click_popup(xpath)  
          ...
          @agent = @agent.element(:xpath => xpath).click_and_attach
        end        
        ...
        def uncheck(xpath)
          return if @options[:perform_click]          
          notify(:uncheck)
          @agent.element(:xpath => xpath).uncheck
        end
        ...
        def click_link_with_index(xpath, index, wait_seconds=0)
          ...
          @agent.elements(:xpath => xpath)[index].click
          sleep wait_seconds          
        end
        ...
        def fill_textfield(xpath, value="")
          ...
          @agent.element(:xpath => xpath).set(value)
        end
        ...
        def check_checkbox(xpath)
          ...
          @agent.element(:xpath => xpath).set(true)
        end
    end
  end
end